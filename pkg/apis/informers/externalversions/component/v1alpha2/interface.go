...
type Interface interface {
	// Capabilities returns a CapabilityInformer.
	Capabilities() CapabilityInformer
...
// Capabilities returns a CapabilityInformer.
func (v *version) Capabilities() CapabilityInformer {
	return &capabilityInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
