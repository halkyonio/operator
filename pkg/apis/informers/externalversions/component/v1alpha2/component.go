	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevexpV1alpha2().Components(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevexpV1alpha2().Components(namespace).Watch(options)
			},
		},
		&componentv1alpha2.Component{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&componentv1alpha2.Component{}, f.defaultInformer)
}
