...
replace (
	...
	github.com/kubernetes-incubator/service-catalog => github.com/kubernetes-incubator/service-catalog v0.1.39
	...
	k8s.io/apimachinary => k8s.io/apimachinery v0.0.0-20181126123746-eddba98df674
